<template>
  <v-container grid-list-xl>
    ...
    <template v-else>
      <v-alert :value="getDataUserProfile.decisionCompleted" color="warning" icon="done" outline>
        Submitted {{getDataUserProfile.decisionCompleted | formatDate}}
      ...
      <v-layout justify-center ma-0>
        <v-dialog sm6 xs12 v-model="getNotification">
          <v-card color class="black--text mt-2 col-sm-6 notification">
            ...
            <v-card-text>
              <p>You have arrived at the part of the Diagnostic within which we gather information to build your Energy Health Decision Profile.</p>
              <p>
                The profile covers the factors from 5 key areas of influence:
                <br />
                <br />1. Socio-Cultural
                <br />2. Situational
                <br />3. People/Relationships
                <br />4. Personal
                <br />5. Mental Health
                <br />
                <br />You are encouraged to provide as much detail as you can, in order to build an accurate Profile. The accuracy will help with developing the most effective responses to manage your Energy Health. Nonetheless, there is no pressure to respond to questions with which you don't feel comfortable.
              </p>
            </v-card-text>
            <v-card-actions>
              <v-btn
