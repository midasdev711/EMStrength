<template>
  <v-container grid-list-xl class="terms">
    <v-card>
      <h2>Terms &amp; Conditions</h2>
      <p>
        These terms and conditions ("Terms", "Agreement") are an agreement between Website Operator ("Website Operator", "us", "we" or "our") and you ("User", "you" or "your"). This Agreement sets forth the general terms and conditions of your use of the energyhealthinc.com website and any of its products or services (collectively, "Website" or "Services").
      </p>
      ...
      <p>You agree to indemnify and hold Website Operator and its affiliates, directors, officers, employees, and agents harmless from and against any liabilities, losses, damages or costs, including reasonable attorneys' fees, incurred in connection with or arising from any third-party allegations, claims, actions, disputes, or demands asserted against any of them as a result of or relating to your Content, your use of the Website or Services or any wilful misconduct on your part.</p>
      <h3>Severability</h3>
      ...
      <h3>Contacting us</h3>
      <p>If you would like to contact us to understand more about this Agreement or wish to contact us concerning any matter relating to it, you may send an email to <a href="mailto:support@energyhealthinc.com">support@energyhealthinc.com</a> 
      <br><br>
      This document was last updated on April 17, 2020</p>
    </v-card>
  </v-container>
</template>
